Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
    ...
    DESC
  s.homepage         = "https://github.com/litoarias/HACClusterMapViewController.git"
  ...
  s.platform         = :ios, "7.0"
  s.source           = { :git => "https://github.com/litoarias/HACClusterMapViewController.git", :tag => "1.0.0" }
